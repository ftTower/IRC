...
/*   Updated: 2024/12/13 14:47:18 by lleciak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parseCmd(Server &serv, int fd, std::string cmd)
{
	...
	void (*foo[])(Server&,int,const std::string &) = {
		nick_cmd, user_cmd, ping_cmd, pong_cmd, version_cmd, pass_cmd, join_cmd, part_cmd, privmsg_cmd, invite_cmd, quit_cmd, mode_cmd, topic_cmd, kick_cmd
	};
